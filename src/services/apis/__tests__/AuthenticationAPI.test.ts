...
describe("Authentication API test", () => {
    ...
    describe("Validate token function test", () => {
        test("Should call GET and return a boolean as validity", async () => {
            const response = { data: { valid: true, permissions: 1 } };
            ...
            expect(permissions).toStrictEqual(response.data.permissions);
            expect(axiosMocks.get).toBeCalledWith(
